...
export default function NotificationsMenu() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-80 max-h-96 overflow-auto rounded-md border bg-popover shadow-lg z-50 p-2 text-sm">
          ...
          {!loading && items.map(n => (
            <div key={n.id} className="rounded-md p-2 hover:bg-accent/40 flex flex-col gap-0.5">
